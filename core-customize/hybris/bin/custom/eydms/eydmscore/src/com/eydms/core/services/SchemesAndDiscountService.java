...
import com.eydms.facades.data.GiftOrderListData;
...
public interface SchemesAndDiscountService {
	...
	Boolean updateInfluencerPoint(EyDmsCustomerModel customer, double redeemPoint, TransactionType transactionType,
