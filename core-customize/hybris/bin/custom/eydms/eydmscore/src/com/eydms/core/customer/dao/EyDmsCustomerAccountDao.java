...
/**
 * Interface for eydms Customer Related DAO
 */
public interface EyDmsCustomerAccountDao extends CustomerAccountDao {
     ...
     List<AddressModel> findEyDmsAddressBookDeliveryEntriesForCustomer(CustomerModel customerModel,
