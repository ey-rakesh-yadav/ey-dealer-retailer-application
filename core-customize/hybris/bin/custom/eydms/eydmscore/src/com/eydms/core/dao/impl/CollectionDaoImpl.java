...
public class CollectionDaoImpl implements CollectionDao{
	...
	@Override
	public Double getSalesForDealer(List<EyDmsCustomerModel> dealerList, Date startDate, Date endDate) {
	...
	@Override
	public List<OrderModel> getCreditBreachedOrders(EyDmsCustomerModel dealer) {
		final Map<String, Object> params = new HashMap<String, Object>();
		...
		builder.append("SELECT {o:pk} from { ").append(OrderModel._TYPECODE).append(" as o} WHERE {o:creditLimitBreached} = ?boolean  ")
				.append(" AND {o:user} = ?user  and ").append(EyDmsDateUtility.getMtdClauseQuery("o:date", params)).append(" AND {o:" + OrderModel.VERSIONID + "} IS NULL");
	...
	public QuarterEndOverdueStatus getDealerQuarterEndOverdueStatus(String customerNo) {
		final Map<String, Object> params = new HashMap<String, Object>();
		final StringBuilder builder = new StringBuilder("SELECT {quarterEndOverdueStatus} FROM {EyDmsCustomer} WHERE {customerNo}=?customerNo");
		params.put("customerNo", customerNo);
		final FlexibleSearchQuery query = new FlexibleSearchQuery(builder.toString());
	...
	@Override
	public SearchPageData<SPInvoiceModel> getSPInvoiceList(EyDmsCustomerModel sp, SearchPageData searchPageData,
