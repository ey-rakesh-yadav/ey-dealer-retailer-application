package com.eydms.integration.cpi.retryPrice;
...
public class EyDmsPricePrcoessingRetriesJob extends AbstractJobPerformable<CronJobModel> {
    ...
    private static final Logger LOG = Logger.getLogger(EyDmsPricePrcoessingRetriesJob.class);

    @Autowired
    EyDmsInboundPriceAction eydmsOutboundPriceAction;
    ...
    public PerformResult perform(CronJobModel arg0) {
        ...
        for (OrderModel order: ordersList) {
            ...
            eydmsOutboundPriceAction.executeEyDmsOutboundPrice(orderProcessModel, order, false);
        }
        return jobResult;
    }
