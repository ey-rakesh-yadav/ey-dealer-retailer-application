...
<html>
<head>
    <title>Welcome to eydmsintegration</title>
    <link rel="stylesheet" href="<c:url value="/static/eydmsintegration-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "eydmsintegration" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/eydmsintegration-items.xml</b> - here you can model your items</li>
            <li><b>resources/eydmsintegration-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/eydmsintegration-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/eydmsintegration-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/eydmsintegration-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
