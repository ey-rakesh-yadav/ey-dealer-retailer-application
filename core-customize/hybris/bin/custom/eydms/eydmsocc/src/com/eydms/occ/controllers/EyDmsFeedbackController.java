...
import com.eydms.facades.data.FeedbackAndComplaintsListData;
 ...
 */
@Controller
@RequestMapping(value = "/{baseSiteId}/users/{userId}/eydmsfeedback")
@ApiVersion("v2")
@Tag(name = "EyDms Feedback Management")
public class EyDmsFeedbackController extends EyDmsBaseController {

    @Resource
    private EyDmsFeedbackFacade eydmsFeedbackFacade;
    ...
    public ReviewWsDTO createFeeback(
        ...
        final ReviewData reviewDataReturn = eydmsFeedbackFacade.postFeedback(orderCode, reviewData);
    ...
    public ReviewListWsDTO getCustomerFeedback(
        ...
        final ReviewDataList reviewDatas = eydmsFeedbackFacade.getCustomerFeedback(orderCode);
    ...
    {
        return eydmsFeedbackFacade.submitInfoDeskFeedback(feedbackAndComplaintsData);
    }
