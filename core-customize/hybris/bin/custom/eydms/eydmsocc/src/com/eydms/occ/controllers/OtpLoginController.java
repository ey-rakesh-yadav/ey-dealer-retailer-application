...
//	}
	 ...
	 @ApiBaseSiteIdParam
	 @ResponseBody
	public boolean validateOTP(@Parameter(description = "otpNum,") @RequestParam final String otpNum, @Parameter(description = "mobileNo") @RequestParam final String mobileNo)
	{
		if(smsOtpFacade.validateOTP(otpNum, mobileNo))
		{
			return true;
		}
		else
