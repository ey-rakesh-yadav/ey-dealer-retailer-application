...
import com.eydms.facades.order.impl.DefaultEYDMSB2BOrderFacade;
...
public class EyDmsOrderHistoryCardPopulator implements Populator<AbstractOrderModel, EyDmsOrderHistoryData> {
    ...
    @Override
    public void populate(AbstractOrderModel source, EyDmsOrderHistoryData target) throws ConversionException {
        ...
        catch (ParseException e)
        {
            ...
            if(source instanceof OrderModel) {
            	...
            	if(orderModel.getRequisitions()!=null && !orderModel.getRequisitions().isEmpty()) {
            		String requisitionId = "";
            		for(OrderRequisitionModel orderRequisitionModel : orderModel.getRequisitions()) {
        ...
        final EyDmsOrderHistoryData eydmsOrderHistoryData){
