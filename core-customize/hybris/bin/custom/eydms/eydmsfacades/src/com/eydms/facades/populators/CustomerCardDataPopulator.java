...
import com.eydms.facades.data.CustomerCardData;
...
public class CustomerCardDataPopulator implements Populator<EyDmsCustomerModel, CustomerCardData> {
    @Resource
    ...
    @Override
    public void populate(EyDmsCustomerModel source, CustomerCardData target) throws ConversionException {
        ...
        if(source.getApplicationDate()!=null) {
        	target.setApplicationDate(EyDmsDateUtility.getFormattedDate(source.getApplicationDate(),"dd MMMM yyyy"));
        }
        ...
        if(source.getApprovedBySoDate()!=null) {
        	target.setApprovedDate(EyDmsDateUtility.getFormattedDate(source.getApprovedBySoDate(),"dd MMMM yyyy"));
        }
        if(source.getRejectedBySoDate()!=null) {
        	target.setRejectedDate(EyDmsDateUtility.getFormattedDate(source.getRejectedBySoDate(),"dd MMMM yyyy"));
        }
        ...
        if(source.getPendingWithSoDate()!=null) {
        	target.setRequestedDate(EyDmsDateUtility.getFormattedDate(source.getPendingWithSoDate(),"dd MMMM yyyy"));
        }
        List<EYDMSAddressData> addresses=new ArrayList<>();
