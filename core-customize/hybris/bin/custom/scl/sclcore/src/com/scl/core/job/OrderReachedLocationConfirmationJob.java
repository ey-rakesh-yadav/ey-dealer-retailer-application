    ...
    public PerformResult perform(CronJobModel cronJobModel) {
        ...
        for(OrderEntryModel entryModel : orderEntryModel) {
            ...
            try{
                ...
                SclUserModel so = territoryManagementService.getSOforCustomer((SclCustomerModel) entryModel.getOrder().getUser());
                sclNotificationService.submitOrderEntryNotification(entryModel.getOrder(),so,bod,sub,category,entryModel.getEntryNumber());

                SclCustomerModel sp = territoryManagementService.getSpForCustomerAndBrand((SclCustomerModel) entryModel.getOrder().getUser(),entryModel.getOrder().getSite());
                sclNotificationService.submitOrderEntryNotification(entryModel.getOrder(),sp,bod,sub,category,entryModel.getEntryNumber());
