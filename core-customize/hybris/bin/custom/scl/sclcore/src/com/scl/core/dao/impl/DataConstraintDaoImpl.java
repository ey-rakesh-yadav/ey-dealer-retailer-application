...
public class DataConstraintDaoImpl extends DefaultGenericDao<DataConstraintModel> implements DataConstraintDao {
    ...
    @Override
    public String findQueryByConstraintName(String constraintName) {
        if(constraintName!=null) {
            Map<String, Object> map = new HashMap<String, Object>();
            map.put(DataConstraintModel.CONSTRAINTNAME, constraintName);
            ...
            final List<DataConstraintModel> dataList = this.find(map);
            if(dataList!=null && !dataList.isEmpty())
                return dataList.get(0).getQuery();
        }
        return null;
    }
    ...
    @Override
    public String findPasswordByConstraintName(String constraintName) {
        if(constraintName!=null) {
            Map<String, Object> map = new HashMap<String, Object>();
            map.put(DataConstraintModel.CONSTRAINTNAME, constraintName);
            ...
            final List<DataConstraintModel> dataList = this.find(map);
            if(dataList!=null && !dataList.isEmpty())
                return dataList.get(0).getPassword();
        }
        return null;
    }
