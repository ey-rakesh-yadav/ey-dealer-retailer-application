...
import com.scl.core.model.DealerInfluencerMapModel;
import com.scl.core.model.DealerRetailerMapModel;
import com.scl.core.model.RetailerInfluencerMapModel;
...
public class UpdateSclCustomerMappingStatusJob extends AbstractJobPerformable<CronJobModel> {

    private static final Logger LOG = Logger.getLogger(UpdateSclCustomerMappingStatusJob.class);
