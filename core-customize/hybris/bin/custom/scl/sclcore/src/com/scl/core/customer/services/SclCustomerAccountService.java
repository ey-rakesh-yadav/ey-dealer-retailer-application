...
public interface SclCustomerAccountService extends CustomerAccountService {
    ...
    void saveAddressEntryForRetailer(final SclCustomerModel retailer , final AddressModel addressModel , final boolean isDefault);

    List<AddressModel> getSclAddressBookDeliveryEntries(CustomerModel customerModel);
}
