...
public class VisitMasterDaoImpl extends DefaultGenericDao<VisitMasterModel> implements VisitMasterDao {
	...
	@Override
	public VisitMasterModel findByRouteAndDate(SclUserModel sclUserModel, Date date) {
		validateParameterNotNullStandardMessage("sclUserModel", sclUserModel);
		validateParameterNotNullStandardMessage("date", date);
		Map<String, Object> map = new HashMap<String, Object>();
		map.put(VisitMasterModel.USER, sclUserModel);
