...
import com.scl.core.model.PurchaseOrderBatchEntryModel;
...
import com.scl.facades.data.PurchaseOrderBatchEntryData;
import com.scl.facades.data.PurchaseOrderBatchEntryListData;
...
public class BulkGoodsServiceImpl implements BulkGoodsService {
	...
	public List<PurchaseOrderBatchData> getListOfTicketsWithGRN(String userId) {
	 ...
	 private CatalogUnawareMediaModel createMediaFromFile(final String uid, final MultipartFile file )  {
	        ...
	        final String mediaCode = uid.concat(SclCoreConstants.UNDERSCORE_CHARACTER).concat("invoice");
