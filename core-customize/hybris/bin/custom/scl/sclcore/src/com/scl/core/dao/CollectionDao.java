...
public interface CollectionDao {
	...
	Double getSalesForDealer(List<SclCustomerModel> dealerList, Date startDate, Date endDate);
	
	Double getSecurityDepositForDealer(String dealer);
	
	List<OrderModel> getCreditBreachedOrders(SclCustomerModel dealer);
	...
	SearchPageData<SPInvoiceModel> getSPInvoiceList(SclCustomerModel sp,
