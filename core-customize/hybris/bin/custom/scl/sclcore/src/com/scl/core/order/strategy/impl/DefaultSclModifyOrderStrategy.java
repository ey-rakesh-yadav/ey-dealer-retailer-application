...
public class DefaultSclModifyOrderStrategy extends DefaultCommerceAddToCartStrategy implements SclModifyOrderStrategy {

    private static final Logger LOGGER = Logger.getLogger(DefaultSclModifyOrderStrategy.class);
    ...
    @Resource
    private SCLB2BOrderService b2bOrderService;
    ...
    public void modiyOrderEntry(final OrderModel orderModel , final CommerceCartParameter parameter ) throws CommerceCartModificationException {
        ...
        if(parameter.getSelectedDeliverySlot()!=null) {
            abstractOrderEntryModel.setExpectedDeliveryslot(deliverySlotMasterDao.findByCentreTime(parameter.getSelectedDeliverySlot()));
        }
