...
import com.scl.facades.data.SlctCrmOrderEntryData;
...
public class RouteMasterCreationJob extends AbstractJobPerformable<CronJobModel> {
    ...
    public PerformResult perform(CronJobModel arg0) {
        ...
        if(userSubAreaMappingModelList.isEmpty()) {
            ...
            for(UserSubAreaMappingModel userSubAreaMappingModel: userSubAreaMappingModelList) {
                if(userSubAreaMappingModel.getBrand()!=null && userSubAreaMappingModel.getSclUser()!=null && userSubAreaMappingModel.getSubAreaMaster()!=null && userSubAreaMappingModel.getState()!=null && !userSubAreaMappingModel.getState().isEmpty()) {
    ...
    public List<UserSubAreaMappingModel> getModifiedUserSubAreaMappingModels() {
        ...
        final StringBuilder builder = new StringBuilder("select {pk} from {UserSubAreaMapping} where ").append(SclDateUtility.getLastXDayQuery("modifiedTime",params,lastXDays));
