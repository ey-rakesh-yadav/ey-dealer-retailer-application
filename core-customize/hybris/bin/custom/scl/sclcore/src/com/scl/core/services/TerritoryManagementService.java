...
public interface TerritoryManagementService {
	...
	List<SubAreaMasterModel> getDistrictsForSO(String state);
	...
	List<SclCustomerModel> getSitesForSubAreaSO(List<String> districtList, List<String> subAreaList);
	...
	List<SclCustomerModel> getSCLAndNonSCLDealersRetailersForSubArea(SubAreaMasterModel subAreaMasterModel,DistrictMasterModel districtMasterModel) ;
	...
	List<SclCustomerModel> getDealerListForRetailer();
	...
	SearchPageData<SclCustomerModel> fetchRetailersForDealer(SearchPageData searchPageData, String searchKey);
