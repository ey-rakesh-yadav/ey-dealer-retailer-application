package com.scl.core.orderhistory.service.impl;
...
public class OrderHistoryServiceImpl implements OrderHistoryService{
	...
	@Override
	public SearchPageData<DeliveryItemModel> getTradeOrderListing(SearchPageData paginationData, String sourceType, String filter, int month, int year, String productName , String orderType, String status)
	{
		final UserModel user = getUserService().getCurrentUser();
