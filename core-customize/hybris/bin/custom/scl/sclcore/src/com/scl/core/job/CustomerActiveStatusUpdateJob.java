...
public class CustomerActiveStatusUpdateJob extends AbstractJobPerformable<CronJobModel> {
    ...
    public List<CustomerSubAreaMappingModel> getAllDealersFromErpOrder() {
        ...
        final StringBuilder builder = new StringBuilder("select distinct {m.pk} from {Order as o join CustomerSubAreaMapping as m on {m:sclCustomer}={o:user} and {m:brand}={o:site}} where  {o:creationTime} >= ?startDate and {m:isActive}=?isActive");
