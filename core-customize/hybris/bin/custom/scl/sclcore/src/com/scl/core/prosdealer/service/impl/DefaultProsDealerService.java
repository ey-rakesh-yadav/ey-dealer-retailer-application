...
import com.scl.core.enums.StatusOfApplicant;
import com.scl.core.enums.VehicleType;
...
public class DefaultProsDealerService implements ProsDealerService {
    ...
    public void uploadDealerDocument(ProspectiveDealerModel prosDealer, String documentType, MultipartFile file) {
        ...
        switch (documentType){
            case SclCoreConstants.DOCUMENT_PAN_CARD:
                CatalogUnawareMediaModel panCard = createMediaFromFile(uid,SclCoreConstants.DOCUMENT_PAN_CARD,file);
                panCard.setAltText(SclCoreConstants.DOCUMENT_PAN_CARD_NAME);
                getModelService().save(panCard);
                prosDealer.setPanCardDoc(panCard);
                break;

            case SclCoreConstants.DOCUMENT_TYPE_BANK_STATEMENT:
                CatalogUnawareMediaModel bankStatement = createMediaFromFile(uid,SclCoreConstants.DOCUMENT_TYPE_BANK_STATEMENT,file);
                bankStatement.setAltText(SclCoreConstants.DOCUMENT_TYPE_BANK_STATEMENT_NAME);
            ...
            case SclCoreConstants.DOCUMENT_TYPE_BLANK_CHEQUE:
                CatalogUnawareMediaModel blankCheque = createMediaFromFile(uid,SclCoreConstants.DOCUMENT_TYPE_BLANK_CHEQUE,file);
                blankCheque.setAltText(SclCoreConstants.DOCUMENT_TYPE_BLANK_CHEQUE_NAME);
                getModelService().save(blankCheque);
                prosDealer.setBlankChequeDoc(blankCheque);
                break;

            case SclCoreConstants.DOCUMENT_TYPE_DD_DETAILS:
                CatalogUnawareMediaModel ddDetails = createMediaFromFile(uid,SclCoreConstants.DOCUMENT_TYPE_DD_DETAILS,file);
                ddDetails.setAltText(SclCoreConstants.DOCUMENT_TYPE_DD_DETAILS_NAME);
                getModelService().save(ddDetails);
                prosDealer.setDdDetailsDoc(ddDetails);
                break;

            case SclCoreConstants.DOCUMENT_TYPE_GODOWN_DETAILS:
                CatalogUnawareMediaModel godownDetails = createMediaFromFile(uid,SclCoreConstants.DOCUMENT_TYPE_GODOWN_DETAILS,file);
                godownDetails.setAltText(SclCoreConstants.DOCUMENT_TYPE_GODOWN_DETAILS_NAME);
            ...
            case SclCoreConstants.DOCUMENT_TYPE_GST_DETAILS:
                CatalogUnawareMediaModel gstDetails = createMediaFromFile(uid,SclCoreConstants.DOCUMENT_TYPE_GST_DETAILS,file);
                gstDetails.setAltText(SclCoreConstants.DOCUMENT_TYPE_GST_DETAILS_NAME);
            ...
            case SclCoreConstants.DOCUMENT_TYPE_LETTER_HEAD_COPY:
                CatalogUnawareMediaModel letterHead = createMediaFromFile(uid,SclCoreConstants.DOCUMENT_TYPE_LETTER_HEAD_COPY,file);
                letterHead.setAltText(SclCoreConstants.DOCUMENT_TYPE_LETTER_HEAD_COPY_NAME);
    ...
    public Boolean saveBasicDetails(BasicProsDealerData basicProsDealerData) {
        ...
        final AddressModel address = modelService.create(AddressModel.class);
           ...
           CompanyModel dummySclUnit = b2bUnitService.getUnitForUid(SclCoreConstants.SCL_PROS_DEALER_DUMMY_UNIT);
           prosDealer.setDefaultB2BUnit((B2BUnitModel) dummySclUnit);

           String userGroup=SclCoreConstants.SCL_PROS_DEALER_DUMMY_USER_GROUP;
           final Set<PrincipalGroupModel> groups = new HashSet<PrincipalGroupModel>(dummySclUnit.getGroups());
    ...
    @Override
    public List<ProspectiveDealerModel> fetchProsDealerPendingForSOAssignment(final SclUserModel districtInCharge){
