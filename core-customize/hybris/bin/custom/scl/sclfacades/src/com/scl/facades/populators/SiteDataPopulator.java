...
import com.scl.facades.data.SiteDetailData;
...
public class SiteDataPopulator implements Populator<SclCustomerModel, SiteDetailData> {
    public static final String COMMA = ",";
    @Resource
    private EnumerationService enumerationService;
    @Override
    public void populate(SclCustomerModel source, SiteDetailData target) throws ConversionException {
