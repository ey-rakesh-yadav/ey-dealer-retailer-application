...
public class DealerAddressDataErrorsPopulator implements Populator<AddressVerificationResult<AddressVerificationDecision>, Errors>
{

	private final Map<String, String> attributeMappingMap;

	public DealerAddressDataErrorsPopulator(final Map<String, String> attributeMappingMap)
	{
