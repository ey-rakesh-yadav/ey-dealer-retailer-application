...
public class DefaultDealerTransitFacade implements DealerTransitFacade {
    ...
    public DealerVehicleDetailsListData getDealerVehicleDetails(final String dealerUid){
        final SclCustomerModel sclCustomer = sclCustomerService.getSclCustomerForUid(dealerUid);
        BigDecimal totalCapacity = BigDecimal.ZERO;
        List<DealerVehicleDetailsModel> dealerVehicleDetailsModelList = dealerTransitService.fetchVehicleDetailsForDealer(sclCustomer);
