...
public class SclCartPopulator<T extends CartData> extends AbstractOrderPopulator<CartModel, T> {
	...
	public void populate(CartModel source, T target) throws ConversionException {
		...
		if(source.getCrmOrderType()!=null) {
			target.setCrmOrderType(source.getCrmOrderType().getCode());
		}
