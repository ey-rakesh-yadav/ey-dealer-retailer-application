...
public class CounterMappingReversePopulator implements Populator<CounterMappingData,SclCustomerModel> {
	...
	@Override
	public void populate(CounterMappingData source, SclCustomerModel target) throws ConversionException {
