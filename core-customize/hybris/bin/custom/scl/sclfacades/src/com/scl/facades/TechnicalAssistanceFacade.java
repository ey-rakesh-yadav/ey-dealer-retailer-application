...
import com.scl.core.model.NetworkAssistanceModel;
...
public interface TechnicalAssistanceFacade {
	...
	SearchPageData<TechnicalAssistanceData> getTechnicalAssistances(SearchPageData searchPageData, String startDate,
															   String endDate, String partnerCode, String requestNo, String filters,List<String> status, List<String> constructionAdvisory,List<String> taluka);
	 ...
	 * @return
	 */
	TSOUserData getTSO(String taluka, String district, String state,String pendingRequest);
}
