...
public class NetworkAdditionPlanPopulator implements Populator<NetworkAdditionPlanModel, SCLNetworkAdditionPlanData> {
    @Autowired
    UserService userService;
    @Override
    public void populate(NetworkAdditionPlanModel source, SCLNetworkAdditionPlanData target) throws ConversionException {
