...
public class CommerceOrderParameterBasicPopulator implements Populator<AddToCartParams, CommerceCartParameter> {
    ...
    public void populate(AddToCartParams addToCartParams, CommerceCartParameter parameter) throws ConversionException {
        ...
        parameter.setAddressPk(addToCartParams.getAddressPk());
        parameter.setRetailerUid(addToCartParams.getRetailerUid());
        parameter.setIncoTerm(addToCartParams.getIncoTerm());
        parameter.setOrderFor(addToCartParams.getOrderFor());
        parameter.setIsDealerProvidingOwnTransport(addToCartParams.getIsDealerProvidingOwnTransport());
        parameter.setDeliveryMode(addToCartParams.getDeliveryMode());
        parameter.setProductAliasName(addToCartParams.getProductAliasName());
    }
}
