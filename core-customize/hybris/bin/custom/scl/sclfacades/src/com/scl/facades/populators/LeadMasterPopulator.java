...
import com.scl.facades.data.LeadMasterData;
...
public class LeadMasterPopulator implements Populator<LeadMasterModel, SclLeadData> {
    @Resource
    ...
    @Override
    public void populate(LeadMasterModel source, SclLeadData target) throws ConversionException {
        if(source!=null) {
            ...
            if(Objects.nonNull(source.getCreatedBy())) {
                ...
                else if (source.getCreatedBy().getGroups().contains(userService.getUserGroupForUID(SclCoreConstants.CUSTOMER.TSM_GROUP_ID))) {
                    target.setGeneratedBy("TSM");
                }
                else if (source.getCreatedBy().getGroups().contains(userService.getUserGroupForUID(SclCoreConstants.CUSTOMER.RH_GROUP_ID))) {
                    target.setGeneratedBy("RH");
                }
                else if (source.getCreatedBy().getGroups().contains(userService.getUserGroupForUID(SclCoreConstants.CUSTOMER.SALES_OFFICER_GROUP_ID))) {
