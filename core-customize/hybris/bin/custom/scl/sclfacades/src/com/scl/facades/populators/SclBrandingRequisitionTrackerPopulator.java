...
public class SclBrandingRequisitionTrackerPopulator implements Populator<BrandingRequestDetailsModel, List<BrandingTrackingData>> {
    ...
    public void populate(BrandingRequestDetailsModel source, List<BrandingTrackingData> target) throws ConversionException {
        ...
        if (source.getRequestRaisedBy().getGroups().contains(userService.getUserGroupForUID(SclCoreConstants.CUSTOMER.SALES_OFFICER_GROUP_ID))) {
...
//            target.add(requestRaisedData);
        ...
        if(source.getRequestRaisedBy().getGroups().contains(userService.getUserGroupForUID(SclCoreConstants.CUSTOMER.DEALER_USER_GROUP_UID)) ||
                source.getRequestRaisedBy().getGroups().contains(userService.getUserGroupForUID(SclCoreConstants.CUSTOMER.RETAILER_USER_GROUP_UID)) )
        {
            BrandingTrackingData requestRaisedData = new BrandingTrackingData();
            requestRaisedData.setCode(BrandingRequestStatus.REQUEST_RAISED.getCode());
            requestRaisedData.setName(getEnumerationService().getEnumerationName(BrandingRequestStatus.REQUEST_RAISED));
        ...
        if (source.getRequestRaisedBy().getGroups().contains(userService.getUserGroupForUID((SclCoreConstants.CUSTOMER.DEALER_USER_GROUP_UID))) || source.getRequestRaisedBy().getGroups().contains(userService.getUserGroupForUID(SclCoreConstants.CUSTOMER.RETAILER_USER_GROUP_UID))) {
        ...
        if (source.getRequestRaisedBy().getGroups().contains(SclCoreConstants.CUSTOMER.SALES_OFFICER_GROUP_ID)) {
