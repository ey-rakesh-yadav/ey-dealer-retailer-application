 ...
 */
@IntegrationTest
public class DefaultSclintegrationServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "sclintegrationPlatformLogo";

		// when
		final String logoUrl = sclintegrationService.getHybrisLogoUrl(logoCode);
