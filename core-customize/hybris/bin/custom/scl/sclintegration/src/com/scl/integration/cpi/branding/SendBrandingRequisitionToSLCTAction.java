...
public class SendBrandingRequisitionToSLCTAction extends AbstractSimpleDecisionAction<SclBrandingProcessModel> {
    ...
    public Transition executeAction(SclBrandingProcessModel sclBrandingProcessModel) throws RetryLaterException, Exception {
        ...
        if(brandingRequisitionDetails!=null && brandingRequisitionDetails.getSlctReqNo()!=null && brandingRequisitionDetails.getReqRaisedRole()!=null)
        {
            ...
            SclOutboundBrandingRequisitionModel outboundBrandingRequisitionModel = getOutboundBrandingRequisitionDetails(brandingRequisitionDetails);
            getSclSapCpiDefaultOutboundService().sendBrandingRequisitionDetailsToSlct(outboundBrandingRequisitionModel).subscribe(
    ...
    private SclOutboundBrandingRequisitionModel getOutboundBrandingRequisitionDetails(BrandingRequestDetailsModel brandingRequisitionDetails) {
        SclOutboundBrandingRequisitionModel outboundBrandingRequisitionModel = new SclOutboundBrandingRequisitionModel();
