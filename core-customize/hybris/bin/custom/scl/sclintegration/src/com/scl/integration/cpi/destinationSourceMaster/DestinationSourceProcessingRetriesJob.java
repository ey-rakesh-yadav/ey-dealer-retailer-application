package com.scl.integration.cpi.destinationSourceMaster;
...
import com.scl.facades.data.LPSourceMasterData;
import com.scl.facades.data.LPSourceMasterListData;
...
public class DestinationSourceProcessingRetriesJob extends AbstractJobPerformable<CronJobModel> {
    ...
    public boolean executeSclOutboundLpSource() {
//        SclOutboundLpSourceModel outboundLpSourceModel = new SclOutboundLpSourceModel();
...
//        callSclOutboundLpSource(outboundLpSourceModel,lpSourceWrapper);
        return true;
    }

//    private void callSclOutboundLpSource(SclOutboundLpSourceModel outboundLpSourceMasterModel, LpSourceWrapper lpSourceWrapper) {
//        lpSourceWrapper.apiCallCount++;
//        LOG.info("LP Souce API count :" + lpSourceWrapper.apiCallCount);
//        getSclSapCpiDefaultOutboundService().getLpSourceData(outboundLpSourceMasterModel).subscribe(
//
//                // onNext
//                responseEntityMap -> {
...
//                            callSclOutboundLpSource(outboundLpSourceMasterModel, lpSourceWrapper);
//                        }
//                        else {
