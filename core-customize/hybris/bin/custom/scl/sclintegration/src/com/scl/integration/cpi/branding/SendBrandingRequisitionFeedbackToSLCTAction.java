...
public class SendBrandingRequisitionFeedbackToSLCTAction extends AbstractSimpleDecisionAction<SclBrandingProcessModel> {
    ...
    public Transition executeAction(SclBrandingProcessModel sclBrandingProcessModel) throws RetryLaterException, Exception {
        ...
        SclOutboundBrandingRequisitionFeedbackModel outboundBrandingRequisitionModel = new SclOutboundBrandingRequisitionFeedbackModel();
        if(brandingRequisitionDetails!=null)
        {
            ...
            getSclSapCpiDefaultOutboundService().sendBrandingRequisitionDetailsFeedbackToSlct(outboundBrandingRequisitionModel).subscribe(
