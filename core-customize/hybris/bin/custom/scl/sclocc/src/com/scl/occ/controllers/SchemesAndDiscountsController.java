...
import com.scl.occ.dto.GiftOrderListWsDTO;
import com.scl.occ.dto.GiftShopListWsDTO;
...
import com.scl.occ.dto.DisburseHistoryListWsDTO;
...
@PermitAll
public class SchemesAndDiscountsController extends SCLB2BOrdersController{
	...
	private static final Logger LOG = Logger.getLogger(SchemesAndDiscountsController.class);
...
//		return schemesFacade.claimGift(placeOrderData);
			...
			throws InvalidCartException, PaymentAuthorizationException
	{
		...
		LOG.info("The gifts cart data is "+cartData);
