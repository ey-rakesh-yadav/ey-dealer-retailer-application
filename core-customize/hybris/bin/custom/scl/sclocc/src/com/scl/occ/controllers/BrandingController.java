...
import com.scl.occ.dto.BrandingRequestDetailsListWsDTO;
...
public class BrandingController  extends SclBaseController {
    ...
    {
        return getDataMapper().map(geographicalRegionFacade.findAllState(),DropdownListWsDTO.class,BASIC_FIELD_SET);
    }
    ...
    {
        return getDataMapper().map(geographicalRegionFacade.findAllDistrict(state),DropdownListWsDTO.class,BASIC_FIELD_SET);
    }
    ...
    {
        return getDataMapper().map(geographicalRegionFacade.findAllTaluka(state, district),DropdownListWsDTO.class,BASIC_FIELD_SET);
    }
    ...
    {
        return getDataMapper().map(geographicalRegionFacade.findAllErpCity(state, district, taluka),DropdownListWsDTO.class,BASIC_FIELD_SET);
    }
    ...
    @Secured({ SclSecuredAccessConstants.ROLE_B2BADMINGROUP, SclSecuredAccessConstants.ROLE_TRUSTED_CLIENT,SclSecuredAccessConstants.ROLE_CUSTOMERMANAGERGROUP})
