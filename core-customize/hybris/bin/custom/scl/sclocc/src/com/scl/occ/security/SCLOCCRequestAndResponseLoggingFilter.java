 ...
 */
@Slf4j
public class SCLOCCRequestAndResponseLoggingFilter extends OncePerRequestFilter {
    private static final Logger log = Logger.getLogger( SCLOCCRequestAndResponseLoggingFilter.class.getName());
