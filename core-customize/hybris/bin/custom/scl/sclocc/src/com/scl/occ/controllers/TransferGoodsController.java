...
public class TransferGoodsController extends SclBaseController{
	...
	public SclUserListData getSalesOfficers(@Parameter(description = "userId") @PathVariable(required = true) String userId, @Parameter(description = "searchKey") @RequestParam(required = true) String searchKey)
	{
