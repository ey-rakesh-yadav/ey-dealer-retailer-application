...
public class DefaultEyDmsFeedbackFacade implements EyDmsFeedbackFacade {

    private EyDmsFeedbackService eydmsFeedbackService;
    ...
    public ReviewData postFeedback(final String orderCode, final ReviewData reviewData) {
        ...
        customerReview = getEyDmsFeedbackService().createFeedback(reviewData.getRating(), reviewData.getHeadline(), reviewData.getComment(), user,product, order);
    ...
    public ReviewDataList getCustomerFeedback(final String orderCode){
        ...
        List<CustomerReviewModel> feedbacks = getEyDmsFeedbackService().getFeedbackForCustomerAndOrder(customer,order);
    ...
    public boolean submitInfoDeskFeedback(FeedbackAndComplaintsData feedbackAndComplaintsData) {
        return eydmsFeedbackService.submitInfoDeskFeedback(feedbackAndComplaintsData);
    }


    public EyDmsFeedbackService getEyDmsFeedbackService() {
        return eydmsFeedbackService;
    }

    public void setEyDmsFeedbackService(EyDmsFeedbackService eydmsFeedbackService) {
        this.eydmsFeedbackService = eydmsFeedbackService;
    }
