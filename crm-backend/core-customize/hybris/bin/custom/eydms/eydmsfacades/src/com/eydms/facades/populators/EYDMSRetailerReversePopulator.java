...
public class EYDMSRetailerReversePopulator implements Populator<EYDMSRetailerData, EyDmsCustomerModel> {
    @Resource
    ...
    @Override
    public void populate(EYDMSRetailerData source, EyDmsCustomerModel target) throws ConversionException {
        ...
        ugSet.add(userService.getUserGroupForUID(EyDmsCoreConstants.CUSTOMER.RETAILER_ONBOARDING_USER_GROUP_UID));
