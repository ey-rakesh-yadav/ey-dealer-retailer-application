...
public class EyDmsSitePopulator implements Populator<B2BCustomerModel,EyDmsSiteData>{

	@Autowired
	Converter<AddressModel, AddressData> addressConverter;
	
	@Override
	public void populate(B2BCustomerModel source, EyDmsSiteData target) throws ConversionException {
