...
public class DealerBasicPopulator implements Populator<EyDmsCustomerModel, CustomerData> {
	...
	@Override
	public void populate(EyDmsCustomerModel source, CustomerData target) throws ConversionException {
		...
		else if(source.getGroups().contains(userService.getUserGroupForUID(EyDmsCoreConstants.CUSTOMER.RETAILER_USER_GROUP_UID))) {
