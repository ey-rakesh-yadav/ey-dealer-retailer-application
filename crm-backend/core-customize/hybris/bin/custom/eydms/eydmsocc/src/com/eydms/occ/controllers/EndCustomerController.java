...
import com.eydms.occ.dto.EndCustomerWsDto;
import com.eydms.occ.dto.EndCustomerListWsDTO;
import com.eydms.occ.dto.EndCustomerDealerWsDto;
import com.eydms.occ.dto.EndCustomerDealerListWsDTO;
import com.eydms.occ.dto.ProductsListWsDTO;
...
public class EndCustomerController extends EyDmsBaseController {

	@Autowired
	EyDmsEndCustomerFacade eydmsEndCustomerFacade;
	...
	public ResponseEntity<String> saveEndCustomerDetails(@Parameter(description = "End Customer Details") @RequestBody final EndCustomerWsDto endCustomerWsDto, @ApiFieldsParam @RequestParam(defaultValue = DEFAULT_FIELD_SET) final String fields) {
		var endCustomerData = dataMapper.map(endCustomerWsDto, EyDmsEndCustomerData.class, fields);
        ...
        String customerUid = eydmsEndCustomerFacade.saveEndCustomerData(endCustomerData);
    ...
    public EndCustomerWsDto getEndCustomerDetails(@ApiFieldsParam @RequestParam(defaultValue = DEFAULT_FIELD_SET) final String fields) {
        var endCustomerRegisteredData = eydmsEndCustomerFacade.getRegisteredEndCustomer();
                                                                ...
                                                                final HttpServletResponse response)
    {
        ...
        EyDmsEndCustomerDealerListData listData = new EyDmsEndCustomerDealerListData();
        SearchPageData<EyDmsEndCustomerDealerData> searchList = eydmsEndCustomerFacade.getDealersList(searchPageData,brand,state,district,city,pincode,influencerType,counterType);
    ...
    public ResponseEntity<Boolean> sendLoginSmsOtp(@RequestParam final String mobileNo) {
        Boolean smsSent = eydmsCustomerFacade.sendOnboardingSmsOtp("",mobileNo);
