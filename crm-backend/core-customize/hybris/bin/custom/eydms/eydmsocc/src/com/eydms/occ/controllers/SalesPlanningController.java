...
import com.eydms.occ.dto.AnnualSalesMonthWiseTargetListWsDTO;
...
public class SalesPlanningController extends EyDmsBaseController {
    @Resource
    ...
    //EyDmsWorkflow -Api to send all approved subarea target of the district to the RH
    @Secured({ EyDmsSecuredAccessConstants.ROLE_B2BADMINGROUP, EyDmsSecuredAccessConstants.ROLE_TRUSTED_CLIENT,EyDmsSecuredAccessConstants.ROLE_CUSTOMERGROUP,EyDmsSecuredAccessConstants.ROLE_CUSTOMERMANAGERGROUP})
    ...
    //EyDmsWorkflow - targetSendForRevision to SO by tsm and DI by rh - TSM and RH persona Monthly
    @Secured({ EyDmsSecuredAccessConstants.ROLE_B2BADMINGROUP, EyDmsSecuredAccessConstants.ROLE_TRUSTED_CLIENT,EyDmsSecuredAccessConstants.ROLE_CUSTOMERGROUP,EyDmsSecuredAccessConstants.ROLE_CUSTOMERMANAGERGROUP})
    ...
    //EyDmsWorkflow - Target Approve By TSM/RH Monthly
    @Secured({EyDmsSecuredAccessConstants.ROLE_B2BADMINGROUP, EyDmsSecuredAccessConstants.ROLE_TRUSTED_CLIENT, EyDmsSecuredAccessConstants.ROLE_CUSTOMERGROUP, EyDmsSecuredAccessConstants.ROLE_CUSTOMERMANAGERGROUP})
