...
//import com.eydms.facades.data.CRMVisitListData;
...
public class SlctCrmIntegrationController extends EyDmsBaseController {
...
//	}
	...
	@Secured({ "ROLE_CUSTOMERGROUP", "ROLE_TRUSTED_CLIENT", "ROLE_CUSTOMERMANAGERGROUP" })
	@RequestMapping(value = "/eydmsCustomerMarketMapping", method = RequestMethod.GET)
	@ResponseBody
	@ApiBaseSiteIdAndUserIdParam
	...
	@Secured({ "ROLE_CUSTOMERGROUP", "ROLE_TRUSTED_CLIENT", "ROLE_CUSTOMERMANAGERGROUP" })
	@RequestMapping(value = "/insertUpdateSalesOrderDeliverySLAData", method = RequestMethod.POST)
	@ResponseBody
	@ApiBaseSiteIdAndUserIdParam
