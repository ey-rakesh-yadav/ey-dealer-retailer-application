...
import com.eydms.test.constants.EyDmsTestConstants;
import com.eydms.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = EyDmsTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/eydmstest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/eydmstest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/eydmstest/import/cstickets.impex");
			...
			importImpexFile(context, "/eydmstest/import/csquotes.impex");
		}
	}
}
