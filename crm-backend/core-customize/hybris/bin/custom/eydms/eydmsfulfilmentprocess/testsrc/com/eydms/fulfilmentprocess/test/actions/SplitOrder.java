 ...
 */
package com.eydms.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(EyDmsFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(EyDmsFulfilmentProcessConstants.PARENT_PROCESS);
