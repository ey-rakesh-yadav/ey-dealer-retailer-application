 ...
 */
@IntegrationTest
public class DefaultEyDmsintegrationServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "eydmsintegrationPlatformLogo";

		// when
		final String logoUrl = eydmsintegrationService.getHybrisLogoUrl(logoCode);
