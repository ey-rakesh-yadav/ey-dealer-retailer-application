 ...
 */
package com.eydms.integration.service.impl;
...
public class DefaultEyDmsintegrationService implements EyDmsintegrationService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultEyDmsintegrationService.class);
	...
	{
		return DefaultEyDmsintegrationService.class.getResourceAsStream("/eydmsintegration/sap-hybris-platform.png");
	}
