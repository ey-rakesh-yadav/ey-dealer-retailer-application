...
public class TerritoryManagementDaoImpl1 implements TerritoryManagementDao1 {
    ...
    //Not to be used
    @Override
    public List<String> getAllSubAreaForSO(UserModel eydmsUser, BaseSiteModel site) {

        final Map<String, Object> params = new HashMap<String, Object>();
        final StringBuilder builder = new StringBuilder("SELECT {subArea} FROM {UserSubAreaMapping} WHERE {eydmsUser} = ?eydmsUser AND {isActive} = ?active AND {brand} = ?brand");
    ...
    public List<String> getAllSubAreaForCustomer(UserModel customer, BaseSiteModel site) {
        ...
        final Map<String, Object> params = new HashMap<String, Object>();
        final StringBuilder builder = new StringBuilder("SELECT {subArea} FROM {CustomerSubAreaMapping} WHERE {eydmsCustomer} = ?customer AND {isActive} = ?active AND {brand} = ?brand");
        boolean active = Boolean.TRUE;
    ...
    //Not to be used
    @Override
    public List<EyDmsCustomerModel> getAllCustomerForSubArea(List<String> subArea, BaseSiteModel site) {
        if (subArea == null || subArea.isEmpty()) {
            subArea = getAllSubAreaForSO(userService.getCurrentUser(), site);
        }
        final Map<String, Object> params = new HashMap<String, Object>();
        final StringBuilder builder = new StringBuilder("SELECT {eydmsCustomer} FROM {CustomerSubAreaMapping} WHERE {subArea} in (?subArea) AND {isActive} = ?active AND {brand} = ?brand");
        boolean active = Boolean.TRUE;
    ...
    //Not to be used
    @Override
    public List<EyDmsCustomerModel> getEYDMSAndNonEYDMSCustomerForSubArea(String state, String district, String subArea, BaseSiteModel site) {
        final Map<String, Object> params = new HashMap<String, Object>();
        final StringBuilder builder = new StringBuilder("SELECT {eydmsCustomer} FROM {CustomerSubAreaMapping} WHERE {subArea} = ?subArea AND {isActive} = ?active AND ({brand} = ?brand OR {brand} is null ) AND {district} = ?district AND {state}= ?state ");
        boolean active = Boolean.TRUE;
        params.put("subArea", subArea);
        params.put("active", active);
        params.put("brand", site);
    ...
    //Not to be used
    @Override
    public List<EyDmsCustomerModel> getAllCustomerForSubArea(String subArea, BaseSiteModel site, String district, String state) {
		/*if(subArea==null || subArea.isEmpty()) {
			subArea = getAllSubAreaForSO(userService.getCurrentUser(), site);
		}*/
        final Map<String, Object> params = new HashMap<String, Object>();
        final StringBuilder builder = new StringBuilder("SELECT {eydmsCustomer} FROM {CustomerSubAreaMapping} WHERE {subArea} =?subArea AND {isActive} = ?active AND {brand} = ?brand AND {district} = ?district AND {state}= ?state");
        boolean active = Boolean.TRUE;
        params.put("subArea", subArea);
        params.put("active", active);
        params.put("brand", site);
    ...
    //To be Checked
    @Override
    public List<List<Object>> getAllStateDistrictSubAreaForCustomer(String eydmsCustomer) {

        final Map<String, Object> params = new HashMap<String, Object>();
        //final StringBuilder builder = new StringBuilder("SELECT {state},{district},{subArea} FROM {CustomerSubAreaMapping as cs join EyDmsCustomer sc on {cs.eydmsCustomer} = {sc.pk}} WHERE {sc.uid} = ?eydmsCustomer AND {isActive} = ?active AND {brand} = ?brand");
        StringBuilder builder = new StringBuilder("SELECT {state},{district},{subArea} FROM {CustomerSubAreaMapping as cs join EyDmsCustomer as sc on {cs.eydmsCustomer} = {sc.pk}} WHERE {sc.uid} = ?eydmsCustomer AND {isActive} = ?active ");
        boolean active = Boolean.TRUE;
        params.put("eydmsCustomer", eydmsCustomer);
        params.put("active", active);
        //params.put("brand", site);
    ...
    @Override
    public List<String> getAllDistrictForSO(UserModel eydmsUser, BaseSiteModel site) {
        final Map<String, Object> params = new HashMap<String, Object>();
        final StringBuilder builder = new StringBuilder("SELECT distinct{s.district} FROM {UserSubAreaMapping as u join SubAreaMaster as s on {u.subAreaMaster} ={s.pk} } WHERE {u.eydmsUser} = ?eydmsUser AND {u.isActive} = ?active AND {u.brand} = ?brand");
        boolean active = Boolean.TRUE;
        params.put("eydmsUser", eydmsUser);
        params.put("active", active);
        params.put("brand", site);
    ...
    @Override
    public List<EyDmsUserModel> getAllUserForDistrict(List<String> districts, BaseSiteModel site) {
        final Map<String, Object> params = new HashMap<String, Object>();
        final String queryString = "SELECT {u.eydmsUser} FROM {UserSubAreaMapping as u join SubAreaMaster as s on {u.subAreaMaster} ={s.pk} } WHERE {s.district} in (?district) AND {u.isActive} = ?active AND {u.brand} = ?brand";
        boolean active = Boolean.TRUE;
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<SubAreaMasterModel> getTerritoriesForSOInLocalView(EyDmsUserModel user) {
...
//    				params.put(CustomerSubAreaMappingModel.ISOTHERBRAND, Boolean.FALSE);
    ...
    @Override
    public SearchPageData<EyDmsCustomerModel> getAllPaginatedCustomerForTerritories(List<SubAreaMasterModel> subAreas, SearchPageData searchPageData) {
        final Map<String, Object> params = new HashMap<String, Object>();
        final StringBuilder sql = new StringBuilder("SELECT {eydmsCustomer} FROM {CustomerSubAreaMapping as csm JOIN " +
                "PrincipalGroupRelation as p on {p:source}={csm:eydmsCustomer} JOIN UserGroup as u on {u:pk}={p:target}} " +
                "WHERE {subAreaMaster} in (?subAreas) AND {isActive} = ?active AND {brand} = ?brand and {eydmsCustomer} is not null " +
                "and {isOtherBrand}=?isOtherBrand AND {u:uid}=?userGroup order by {eydmsCustomer}");
        boolean active = Boolean.TRUE;
        String userGroup = "EyDmsInfluencerGroup";
        params.put("subAreas", subAreas);
        params.put("active", active);
    ...
    public List<SubAreaMasterModel> getTerritoriesForCustomer(UserModel customer) {
        ...
        final Map<String, Object> params = new HashMap<String, Object>();
        final StringBuilder builder = new StringBuilder("SELECT {subAreaMaster} FROM {CustomerSubAreaMapping} WHERE {eydmsCustomer} = ?customer AND {isActive} = ?active AND {brand} = ?brand and {eydmsCustomer} is not null and {isOtherBrand}=?isOtherBrand ");
        params.put("customer", customer);
        params.put("active", Boolean.TRUE);
        params.put("brand", baseSiteService.getCurrentBaseSite());
        params.put(CustomerSubAreaMappingModel.ISOTHERBRAND, Boolean.FALSE);
    ...
    @Override
    public List<EyDmsCustomerModel> getAllCustomerForTerritories(List<SubAreaMasterModel> subAreaMaster) {
        final Map<String, Object> params = new HashMap<String, Object>();
    ...
    @Override
    public List<EyDmsCustomerModel> getAllEyDmsAndNonEyDmsCustomerForTerritory(List<SubAreaMasterModel> subAreaMaster) {
        final Map<String, Object> params = new HashMap<String, Object>();
        final StringBuilder builder = new StringBuilder("SELECT {eydmsCustomer} FROM {CustomerSubAreaMapping} WHERE {subAreaMaster} in (?subAreaMaster) AND {isActive} = ?active AND {brand} = ?brand and {eydmsCustomer} is not null ");
        boolean active = Boolean.TRUE;
        params.put("subAreaMaster", subAreaMaster);
    ...
    public SearchPageData<EyDmsCustomerModel> getCustomerByTerritoriesAndCounterType(SearchPageData searchPageData, List<SubAreaMasterModel> subAreaMaster, String counterType, String networkType, boolean isNew, String filter, String influencerType, String dealerCategory) {
        final Map<String, Object> params = new HashMap<String, Object>();
        final StringBuilder builder = new StringBuilder("SELECT {m.eydmsCustomer} FROM {CustomerSubAreaMapping as m join EyDmsCustomer as c on {c.pk}={m.eydmsCustomer} } WHERE {m.subAreaMaster} in (?subAreaMaster) AND {m.counterType}=?counterType AND {m.isActive} = ?active AND {m.brand} = ?brand and {m.eydmsCustomer} is not null and {m.isOtherBrand}=?isOtherBrand ");
        boolean active = Boolean.TRUE;
        params.put("subAreaMaster", subAreaMaster);
        params.put("active", active);
        params.put("brand", baseSiteService.getCurrentBaseSite());
    ...
    @Override
    public List<EyDmsCustomerModel> getCustomerByTerritoriesAndCounterTypeWithoutPagination( String counterType,List<SubAreaMasterModel> subAreaMaster, String networkType, String filter, String influencerType, String dealerCategory,boolean isNew) {
        final Map<String, Object> params = new HashMap<String, Object>();
        final StringBuilder builder = new StringBuilder("SELECT {m.eydmsCustomer} FROM {CustomerSubAreaMapping as m join EyDmsCustomer as c on {c.pk}={m.eydmsCustomer} } WHERE {m.subAreaMaster} in (?subAreaMaster) AND {m.counterType}=?counterType AND {m.isActive} = ?active AND {m.brand} = ?brand and {m.eydmsCustomer} is not null and {m.isOtherBrand}=?isOtherBrand ");
        boolean active = Boolean.TRUE;
        params.put("subAreaMaster", subAreaMaster);
    ...
    @Override
    public List<EyDmsCustomerModel> getAllSalesOfficersByDistrict(String district, BaseSiteModel site) {
        final Map<String, Object> params = new HashMap<String, Object>();
        final StringBuilder builder = new StringBuilder("SELECT distinct {us.eydmsCustomer} FROM {CustomerSubAreaMapping as us join EyDmsCustomer as u on {us.eydmsCustomer}={u.pk} join SubAreaMaster as sm on {sm.pk}={us.subAreaMaster}} WHERE {sm.district}=?district AND {us.brand}=?brand AND {us.isActive}=?active AND {us.isOtherBrand}=?isOtherBrand ");
        boolean active = Boolean.TRUE;
        params.put("district", district);
        params.put("brand", site);
        params.put("active", active);
    ...
    @Override
    public List<EyDmsCustomerModel> getAllSalesOfficersByTaluka(String taluka, BaseSiteModel site) {
        final Map<String, Object> params = new HashMap<String, Object>();
    ...
    private String getCustomerForUserQuery(RequestCustomerData requestCustomerData, List<SubAreaMasterModel> subAreaMasterList, Map<String, Object> params) {
        final StringBuilder builder = new StringBuilder("SELECT {c.pk} FROM {CustomerSubAreaMapping as m join EyDmsCustomer as c on {m.eydmsCustomer}={c.pk}} WHERE {m.subAreaMaster} in (?subAreaList) ");
