...
public class AfterSORejectOnboardingWorkflowDecisionAction extends B2BAbstractWorkflowAutomatedAction {

    private static final Logger LOG = Logger.getLogger(AfterSORejectOnboardingWorkflowDecisionAction.class);
    ...
    public void performAction(final WorkflowActionModel action)
    {
        ...
        try
        {
            ...
            prospectiveDealerModel.setOnboardingStatus(OnboardingStatus.REJECTED_BY_SO);
