    ...
    public class CustomerQueryAcknowledgeAlertJob extends AbstractJobPerformable<CronJobModel> {
        ...
        public PerformResult perform(CronJobModel cronJobModel) {
            try{
                ...
                final int hrs = configurationService.getConfiguration().getInt(EyDmsCoreConstants.NOTIFICATION_EXPIRY);
                ...
                sOProsDealersList.stream()
                        ...
                        .forEach(prosDealer -> {
                            ...
                            notification.setSubject(EyDmsCoreConstants.CUSTOMER_QUERY_ALERT_TITLE);
                            notification.setBody(EyDmsCoreConstants.CUSTOMER_QUERY_ALERT_CONTENT);
