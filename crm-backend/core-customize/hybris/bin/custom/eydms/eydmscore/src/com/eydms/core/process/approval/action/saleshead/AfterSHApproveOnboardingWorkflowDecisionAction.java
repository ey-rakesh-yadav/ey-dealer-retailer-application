 ...
 * workflow
 */
public class AfterSHApproveOnboardingWorkflowDecisionAction extends B2BAbstractWorkflowAutomatedAction {

    private static final Logger LOG = Logger.getLogger(AfterSHApproveOnboardingWorkflowDecisionAction.class);
    ...
    public void performAction(WorkflowActionModel action) {
        ...
        try
        {
            ...
            prospectiveDealerModel.setOnboardingStatus(OnboardingStatus.APPROVED_BY_SH);
