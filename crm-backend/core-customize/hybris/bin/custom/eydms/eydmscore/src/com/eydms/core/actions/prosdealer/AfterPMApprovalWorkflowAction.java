...
public class AfterPMApprovalWorkflowAction extends B2BAbstractWorkflowAutomatedAction
{
		...
		for (final ItemModel attachment : action.getAttachmentItems())
		{
			if (attachment instanceof BusinessProcessModel)
			{
				...
				final String eventName = (String) this.getProcessParameterHelper()
						.getProcessParameterByName(process, EyDmsCoreConstants.PROCESSING_CONSTANT.EVENT_AFTER_PM_APPROVAL_PARAM_NAME).getValue();
				if (eventName != null)
				{
